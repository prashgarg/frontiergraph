...
\paragraph{Fixed-budget retrieval.} The evaluation problem is about how many suggestions a researcher is willing to inspect. That is why the paper emphasizes Recall@100, other fixed-budget shortlist measures, and frontier-style comparisons over larger \(K\).
