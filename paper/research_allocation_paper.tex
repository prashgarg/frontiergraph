...
The distinction matters because the research problem and the product problem are not the same. The paper is about whether a graph-based ranking can prospectively surface plausible next questions. The site is about how to make that ranking legible enough to be useful. In practice, the website solves three narrower problems. It lowers search costs by turning a large graph into a browsable list of candidate questions. It lowers interpretation costs by exposing the local supporting structure rather than only a score. And it lowers handoff costs between discovery and reading by linking surfaced questions to nearby concepts, mediators, and evidence.
