...
\graphicspath{{../site/public/paper-assets/paper-display/}{./}}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.90\linewidth]{figure-01-fig-extraction-flow.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.90\linewidth]{figure-08-fig-main-benchmark.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.78\linewidth]{figure-05-fig-gap-boundary.png}
