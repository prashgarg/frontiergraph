...
- `app/`: Streamlit Explorer for deeper inspection
...
- `Dockerfile`: container build for the Explorer deployment
...
Those paths correspond most closely to the public product and release workflow.
