...
This paper studies research allocation in economics: how to identify questions that are grounded enough to be credible, open enough to matter, and concrete enough to become a paper. I build a claim graph from a field-weighted citation impact selected published-journal corpus of 242,595 papers spanning 1976-2026. Nodes are extracted concepts, while links summarize claim-like relations already observed in papers. Missing links become candidate next papers. I rank them with a graph-based score that combines path support, underexploration gaps, motif support, and hub penalties, and I evaluate the ranking prospectively using leakage-controlled vintage backtests over 3-, 5-, 10-, and 15-year horizons. The main benchmark is preferential attachment, a cumulative-advantage rule that favors links between already central concepts. In the strict shortlist benchmark, preferential attachment remains difficult to beat. But the graph-based rule becomes more competitive at broader screening frontiers and in some parts of the literature, especially outside the most central core and in design-based causal slices. A complementary path-evolution audit suggests that the literature often adds mediating structure around existing direct claims more often than it closes a missing direct link already implied by local paths. Alongside the empirical exercise, the paper introduces [frontiergraph.com](https://frontiergraph.com/) as a public interface for browsing candidate questions and inspecting the graph structure behind them.
...
### 5.2 Where structure helps more
...
![Figure 6](/paper-assets/outputs/paper/13_heterogeneity_atlas/figures/pooled_frontier_main.png)
...
![Figure 7](/paper-assets/outputs/paper/13_heterogeneity_atlas/figures/method_theory_forest_main.png)
...
![Figure 8](/paper-assets/outputs/paper/13_heterogeneity_atlas/figures/subfield_heatmap_main.png)
...
### 5.3 Path evolution beyond direct-link closure
...
![Figure 9](/paper-assets/outputs/paper/13_heterogeneity_atlas/figures/path_evolution_comparison.png)
...
![Figure 10](/paper-assets/outputs/paper/13_heterogeneity_atlas/figures/path_transition_mix_by_source.png)
...
![Figure 11](/paper-assets/outputs/paper/13_heterogeneity_atlas/figures/path_transition_mix_by_subfield.png)
...
These limits define the scope rather than emptying out the exercise. The paper offers an inspectable and prospectively testable screening object for research allocation in economics. Empirically, the contribution is two-sided: the strict shortlist result shows how hard cumulative advantage is to beat, while the heterogeneity and path-evolution results show where that pooled headline is too narrow. If the next iteration can incorporate stronger credibility weighting and richer path-based objects without losing interpretability, it will offer a more serious account of where economics goes next than either pure popularity benchmarks or free-form ideation tools can provide on their own.
...
## Appendix E. Path-evolution extensions
...
## Appendix F. Tool and interpretation notes
