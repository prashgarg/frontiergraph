...
- `h5_shortlist_top100`: 34.0%
- `h10_transparent_top100`: 5.0%
- `h10_reranker_top100`: 21.5%
- `h10_surface_top100`: 57.5%
- `h10_shortlist_top100`: 35.0%

## Top tracked families from the cleaned shortlist

- `carbon emissions` | corpus=0.65%, recent=1.22%, h5_short=11.50%, h10_short=11.50%
...
- `green innovation` | corpus=0.05%, recent=0.10%, h5_short=5.50%, h10_short=6.00%
...
- `technological innovation` | corpus=0.06%, recent=0.12%, h5_short=4.00%, h10_short=4.00%
